...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printStartLine(HttpServletRequest request){
        ...
        System.out.println("request.gerQueryString() = " + request.getQueryString()); //username=hi
    ...
    private void printHeaders(HttpServletRequest request){
        ...
        request.getHeaderNames().asIterator()
                .forEachRemaining(hederName -> System.out.println(hederName + ": "
                        + request.getHeader(hederName)));
    ...
    private void printHeaderUtils(HttpServletRequest request){
        ...
        System.out.println("request.getServiceName() = " + request.getServerName()); //Host 헤더
